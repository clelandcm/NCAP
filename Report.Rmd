...
```{r, eval=FALSE}
scon_vars <- intersect(names(DT), c("participant_id", meta_DT[form == "screening_consent_form",]$var))
scrn_vars <- intersect(names(DT), c("participant_id", meta_DT[form == "screening",]$var))
...
bl_vars <- intersect(names(DT), c("participant_id", meta_DT[form == "baseline",]$var))
fu1_vars <- intersect(names(DT), c("participant_id", meta_DT[form == "followup_interview_1_6weeks",]$var))
fu2_vars <- intersect(names(DT), c("participant_id", meta_DT[form == "followup_interview_2_12weeks_c6e6",]$var))
...
haven::write_sav(DT[, .SD, .SDcols = checklist_vars],
                 path = "c:/Dbox/NCAP Data/Exported for NCAP Team/SPSS/NCAP-Checklist-Vars.sav")
...
haven::write_dta(DT[, .SD, .SDcols = checklist_vars],
                 path = "c:/Dbox/NCAP Data/Exported for NCAP Team/Stata/NCAP-Checklist-Vars.dta")
```
