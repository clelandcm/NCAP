...
### Due
```{r}
DT[redcap_event_name == "baseline_interview_arm_2", FU1_Due := ifelse(difftime(Sys.Date(), bl_date) < 42, "FU1 Not Due Yet", "FU1 Due, 42+ Days Since Baseline")]
...
### Due
```{r}
DT[redcap_event_name == "baseline_interview_arm_2", FU2_Due := ifelse(difftime(Sys.Date(), bl_date) < 84, "FU2 Not Due Yet", "FU2 Due, 84+ Days Since Baseline")]
